                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="url" class="form-control" required
                                                value="{{ old('source_url') }}" placeholder="{!! __('admin.Source Url') !!}"
                                                name="source_url">
                                            @error('source_url')
                                                <br>
                                                <div class="alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="url" class="form-control" required value="{{ old('image') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea id="textarea" class="form-control" name="content" placeholder="اكتب هنا ">{{ old('content') }}</textarea>
                                            @error('content')
                                                <br>
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror

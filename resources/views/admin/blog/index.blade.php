                                    ...
                                    @canany(['create blog'])
                                        <a href="{{ route('blog.get') }}">
                                            <button class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                                                aria-controls="products-table" type="button" data-bs-toggle="offcanvas"
                                                data-bs-target="#offcanvasEcommerceCategoryList"><span><i
                                                        class="bx bx-plus me-0 me-sm-1"></i>جلب مقالات</span></button>
                        ...
                        <tbody>
                            @foreach ($blogs as $blog)
                                <tr class="odd">
                                            ...
                                            <div class="avatar-wrapper">
                                                <div class="avatar avatar me-2 rounded-2 bg-label-secondary">
                                                    <a href="{{ $blog->image }}" target="_blank">
                                                        <img src="{{ $blog->image }}" class="rounded-2">
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <td>{{ $blog->views }}</td>
                                    <td><span
                                            class="text-nowrap">{{ \Carbon\Carbon::parse($blog->created_at)->format('Y-m-d h:i:s A') }}
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content-center">
                                            @canany(['edit blog'])
                                                ...
                                                <a target="_blank" href="{{ route('blog_details', $blog->slug) }}">
